...
public class InnerHelper {
	public static void outputOrRedirect(HttpServletRequest request, HttpServletResponse response, Object handler, int status, String msgI18NKey, String redirectTo) throws IOException, ServletException {
