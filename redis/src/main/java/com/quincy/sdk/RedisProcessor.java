...
public interface RedisProcessor {
	public char[] vcode(HttpServletRequest request, VCodeCharsFrom charsFrom, int length, VCcodeSender sender) throws Exception;
	...
	public char[] vcode(HttpServletRequest request, VCodeCharsFrom charsFrom, int length, String emailTo, String subject, String content) throws Exception;
